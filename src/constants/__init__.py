...
S3_BUCKET_URI = 's3://language-audio-data6/dataset/'
...
S3_ARTIFACTS_URI: str = "s3://language-audio-data6/transformation-artifacts/"
...
S3_BUCKET_MODEL_URI: str = "s3://language-audio-data6/model/"
